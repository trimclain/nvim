local options = {
    ...
    expandtab = CONFIG.opts.spaces_over_tabs, -- use spaces instead of tabs
    ...
    winborder = CONFIG.ui.border, -- the default border style of floating windows
    winminwidth = 5, -- minimum window width
    wrap = CONFIG.opts.word_wrap, -- display lines as one long line
